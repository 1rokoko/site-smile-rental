...
$result1 = echo "925LudK9Bv" | ssh root@38.180.122.239 "pm2 delete all"
...
$result2 = echo "925LudK9Bv" | ssh root@38.180.122.239 "cd /var/www/smilerentalphuket.com/site-smile-rental && pm2 start 'npm run dev' --name smile-rental-dev"
...
$result4 = echo "925LudK9Bv" | ssh root@38.180.122.239 "curl -I http://localhost:3000"
Write-Host "Local app result: $result4" -ForegroundColor White

# Step 5: Test domain
Write-Host "Step 5: Testing domain..." -ForegroundColor Yellow
$result5 = echo "925LudK9Bv" | ssh root@38.180.122.239 "curl -I http://smilerentalphuket.com"
