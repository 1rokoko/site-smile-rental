...
echo 925LudK9Bv | ssh -o StrictHostKeyChecking=no root@38.180.122.239 "docker system prune -af"
...
echo 925LudK9Bv | ssh -o StrictHostKeyChecking=no root@38.180.122.239 "journalctl --vacuum-time=7d"

echo.
echo Шаг 4: Очищаем apt cache...
echo 925LudK9Bv | ssh -o StrictHostKeyChecking=no root@38.180.122.239 "apt clean && apt autoremove -y"
