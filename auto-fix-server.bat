@echo off
echo AUTO-FIXING SERVER WITH PASSWORD [REMOVED]
...
(echo [REMOVED]) | ssh -o StrictHostKeyChecking=no root@38.180.122.239 "ls -la /var/www/smilerentalphuket.com/site-smile-rental/package.json"
