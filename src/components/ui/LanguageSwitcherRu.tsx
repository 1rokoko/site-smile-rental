...
interface LanguageSwitcherRuProps {
  className?: string;
}
...
export const LanguageSwitcherRu: React.FC<LanguageSwitcherRuProps> = ({ className }) => {
  ...
  const handleLanguageChange = (languageCode: string) => {
    ...
    if (languageCode === 'en') {
      // Redirect to main page (English)
      window.location.href = '/';
    } else if (languageCode === 'ru') {
      // Stay on current Russian page
      console.log('Already on Russian page');
    }
  };
