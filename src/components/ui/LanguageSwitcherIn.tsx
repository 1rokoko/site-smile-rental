...
interface LanguageSwitcherInProps {
  className?: string;
}
...
const INFlag: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} viewBox="0 0 60 40" xmlns="http://www.w3.org/2000/svg">
    ...
    <circle cx="30" cy="20" r="4.2" fill="#000080" />
...
export const LanguageSwitcherIn: React.FC<LanguageSwitcherInProps> = ({ className }) => {
  const [currentLanguage, setCurrentLanguage] = useState('in');
