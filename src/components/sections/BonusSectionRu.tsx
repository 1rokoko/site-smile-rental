...
export const BonusSectionRu: React.FC = () => {
  const { bonus } = EXACT_CONTENT_RU;
        ...
        <FadeInView animation="scaleIn" delay={0.3} className="mt-16">
          <div className="bg-gradient-to-r from-primary/10 to-secondary/10 rounded-2xl p-8 text-center">
            ...
            <Body className="text-text-secondary max-w-2xl mx-auto">
              Испытайте Пхукет как никогда раньше с нашими тщательно подобранными маршрутами и эксклюзивными партнерствами.
            </Body>
          </div>
        </FadeInView>
      </Container>
